      ...
      withFile(async (o) => {
        ...
        await withFile(async (o) => {
          ...
          try {
            ...
            winston.debug('[img_converter.js] <Webp> dwebp ' + args.join(' '))
            let { stdout, stderr } = await execa(this.dwebp_binary, args, { timeout: 30000 })
            ...
            winston.warn('[img_converter.js] <Webp> dwebp failed', e)
            reject(e)
          }
        }, { postfix: '.png' })
      }, { postfix: '.webp' })
